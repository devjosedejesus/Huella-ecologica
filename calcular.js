...
function mostrarsuma(){
    ...
    if(total_value<1.6){
     alert("¡¡Bien hecho!! Si obtuviste menos de 1.6 hectáreas vives dentro de los límites naturales del planeta: ¡eres un ejemplo a seguir!"+total_value);
    }
    else if(total_value>=1.6 && total_value<1.8){
    	alert("¡¡cuidado!! Aunque te encuentras dentro de los límites que necesitas para satisfacer tus consumos cotidianos, corres el riesgo de sobrepasar las 1.8 hectáreas:"+total_value);
    }else{
      	alert(" significa que tu estilo de vida es completamente insostenible. Si todo el mundo consumiera los mismos recursos que consumes tú, sería necesario otro planeta Tierra que nos apoye para mantener a toda la población"+total_value);	
    }
